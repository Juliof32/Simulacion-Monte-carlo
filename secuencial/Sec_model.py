...
def run_sequential_simulation(H, W, DAYS):
    """
    Función adaptadora para run_scaling.py
    Ejecuta la simulación secuencial sin GIF.
    """
...
if __name__ == "__main__":
    ...
    print("Tiempo secuencial (test):", t, "s")
    # guardar gif demo
    imageio.mimsave("secuencial\Animation\sir_seq_demo.gif", frames, fps=60)
